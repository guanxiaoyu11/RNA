...
parser.add_argument('--data_dir', type=str, default=r".\raw_data\siRNA")
parser.add_argument('--plot_dir', type=str, default=r".\plot\si_plot")
parser.add_argument('--save_data_dir', type=str, default=r".\save_data\siRNA")
parser.add_argument('--save_fea_dir', type=str, default=r".\save_fea\siRNA")
...
def get_train_data():
    ...
    array1 = []
    array = [[]]
    file = args.data_dir + r"\siRNA_0000.abf"
...
def plot():
    sirna_data = np.load(args.save_data_dir+r"\siRNA.npz")
    data = sirna_data['arr_0']
    array_c = []
    ...
    # del (array_c[0])
    save_fea_fir = args.save_fea_dir+ r"\siRNA_fea.npz"
    np.savez(save_fea_fir, array_c)
# data=get_train_data()
# save_data=args.save_data_dir+r"\siRNA.npz"
